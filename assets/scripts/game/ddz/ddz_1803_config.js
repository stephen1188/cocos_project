cc.Class({
    ...
    loadSaveConfig:function(){
        ...
        var conf = cc.sys.localStorage.getItem("last_game_ddz_1803");
        if(conf){
            ...
            this.node.getChildByName('gametype').getChildByName('boomT').getComponent(cc.Toggle).isChecked = json.boomT==1;
    ...
    Config:function(){
        ...
        var boomT = gametype.getChildByName('boomT').getComponent(cc.Toggle).isChecked ? 1 : 0;
