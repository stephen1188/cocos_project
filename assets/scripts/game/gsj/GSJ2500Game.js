cc.Class({
    ...
    onLoad () {
        ...
        cc.vv.game = this;
        //推倒胡配置
        var const_tdh = require("GSJ2500Const");
        cc.vv.game.config = {
             type:"3dmj",
             name:"gsj",
    ...
    start () {
        ...
        //回放
        var ReplayMgr = require("GSJ2500ReplayMgr");
    ...
    onBtnClick:function(event, data){
        ...
        switch(event.target.name){
            case "game_sync_push":{
                var data = {"errcode":0,"data":{"liupaiCnt":0,"button":0,"numofmj":80,"chuPai":-1,"state":3,"turn":0,"zhuang":0,"seats":[{"que":0,"chis":[],"huinfo":[],"iszimo":false,"folds":[],"baoting":false,"wangangs":[],"guohu":false,"userid":3208,"huas":[],"piaonum":0,"huanpais":[],"diangangs":[],"m_bBaoTing_index":-1,"angangs":[],"holds":[6,13,1,4,6,11,13,14,16,26,29,32,33,37],"pengs":[],"hued":false,"status":2},{"que":0,"chis":[],"huinfo":[],"iszimo":false,"folds":[],"baoting":false,"wangangs":[],"userid":3244,"huas":[],"piaonum":0,"huanpais":[],"diangangs":[],"m_bBaoTing_index":-1,"angangs":[],"pengs":[],"hued":false,"status":2},{"que":0,"chis":[],"huinfo":[],"iszimo":false,"folds":[],"baoting":false,"wangangs":[],"userid":3210,"huas":[],"piaonum":0,"huanpais":[],"diangangs":[],"m_bBaoTing_index":-1,"angangs":[],"pengs":[],"hued":false,"status":2}],"magicPai":24,"saizi_2":5,"saizi_1":5},"errmsg":"ok","model":"game","event":"game_sync_push"}
    ...
    //获取第14张牌放入的位置
    getFourteenTo:function(magicpai){
        var paiIndex = 13;
        //自己手牌
        ...
        for (var index = selfStartIndex; index < selfStartIndex + selfLength; index++) {
            if(pai[index - selfStartIndex] == magicpai){
                continue;
            }
