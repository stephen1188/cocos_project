...
var ACTION_HUJIAOZHUANYI = 17;
var ACTION_GUOPENG = 18
...
cc.Class({
    ...
    takeAction:function(){
        ...
        else if(action.type == ACTION_TING)
        {
            ...
            return 1.0;
        }else if(action.type == ACTION_GUOHU)
        {
            cc.vv.mahjongMgr.doGuoHu({seatid:action.si});
            return 0.5;
        }else if(action.type == ACTION_GUOPENG)
        {
            cc.vv.mahjongMgr.doGuoPeng({seatid:action.si});
            return 0.5;
        }
        else if(action.type == ACTION_HUJIAOZHUANYI)
        {
            cc.vv.mahjongMgr.doHujiaozhuanyi({seatid:action.si});
            return 0.5;
        }
    }
});
