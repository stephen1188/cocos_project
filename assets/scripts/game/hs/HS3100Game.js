cc.Class({
    ...
    onLoad () {
        ...
        cc.vv.game = this;
        //推倒胡配置
        var const_tdh = require("HS3100Const");
        cc.vv.game.config = {
             type:"3dmj",
             name:"hs3100",
             ...
             isXiayu:true,
             isGuoPeng:true,
             isyipaoduoxiang:false,
             show_watch_btn:false,//是否显示观战按钮
             is_sanguiyi:true,
             is_show_fanshu:true,
             is_tingfan:true,//听牌显示番数
             is_showtingdown:true,//自己的牌下面显示听牌
             is_showgangfen:true,//小结算单独显示杠分
             is_showzimo:true,//小结算显示自摸图标
             is_lastGenZhuangSuccess:true,//小结算显示上局跟庄
             is_lastLiuJuSuccess:true,//小结算显示上局跟庄
             is_lastLiuJuScore:true,//小结算流局分
             is_kaiju:true,//是否播放开局动画
             is_no_fapaiAnimation:true,//是否不发牌
             is_time_jiesuan:true,//结算不延迟
             is_showHuangZhuang:true,//是否显示荒庄
         };
    },
    ...
    start () {
        ...
        //回放
        var ReplayMgr = require("HS3100ReplayMgr");
    ...
    initEventHandlers:function(){
        ...
        this.node.on('game_begin',function(){
            ...
            if(cc.vv.game.config.is_showHuangZhuang){
                self.dispatchEvent('huangzhuang_table');
            }
        });
        ...
        //显示过胡
        this.node.on('guopeng_game',function(data){
            self.dispatchEvent("guopeng_table", data);
        });
