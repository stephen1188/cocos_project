...
cc.Class({
    ...
    onLoad(){
        ...
        //牛牛配置
        var const_nn = require("DSG2100Const");
        cc.vv.game = this;
        cc.vv.game.config = {
            type:"dsg",
    ...
    start(){
        ...
        // //回放
        var ReplayMgr = require("DSG2100ReplayMgr");
    ...
    report:function(data){
        ...
        var list;
        if (cc.vv.roomMgr.real - hasJoinedBattle <= 5){
        ...
        switch(data.stage){
            ...
            case 2:{
                ...
                for(var i = 0;i< data.bet.length;i++){
                    var viewid = cc.vv.roomMgr.viewChairID(i);
                    if(viewid == 0){
                        if(data.bet[i].qiang == 0  && data.stage == 2){
                            this.kaiqiang();
                        }
                    }
                }
            ...
            case 4:{
                ...
                if(iskaipai)
                {
                    ...
                    this.btnfanpai.active = true;
                    this.btncuopai.active = true;
                    if(cc.vv.roomMgr.param.wanfa == 3){
                        this.btncuopai.active = false;
                    }
                    var is_watch_game = this.watch_game();
                    if(is_watch_game){
