...
cc.Class({
       ...
       this.pai2.on(cc.Node.EventType.TOUCH_MOVE,function(event){
        ...
        function setpai1(){
            ...
            self.pai1.on(cc.Node.EventType.TOUCH_CANCEL,function(event){
                ...
                self.pai1.zIndex = 0;
                self.pai1.setPosition(133, -82);
                self.pai2.setPosition(-116,-82);
        ...
        this.pai2.on(cc.Node.EventType.TOUCH_END,function(event){
            ...
            var callfunc = cc.callFunc(function(){
                ...
                self.pai2.getComponent(cc.Sprite).spriteFrame=self.title1;
            ...
            //self.pai2.getChildByName("pai").active=true;
            self.pai2.runAction(cc.sequence(cc.moveTo(0.3,cc.v2(0,-82)),callfunc));
        ...
        this.node.on("cuopai",function(data){
            ...
            if(data.hand[0] == 33){
                self.pai2.getChildByName("pai").getComponent(cc.Sprite).spriteFrame=self.typeAtlas.getSpriteFrame("F7"); 
            }
            self.pai1.getComponent(cc.Sprite).spriteFrame=self.title1; 
            self.pai1.getChildByName("pai").active = true;
            self.pai1.getChildByName("pai").getComponent(cc.Sprite).spriteFrame=self.typeAtlas.getSpriteFrame("B"+data.hand[1]);  
            if(data.hand[1] == 33){
                self.pai1.getChildByName("pai").getComponent(cc.Sprite).spriteFrame=self.typeAtlas.getSpriteFrame("F7"); 
            }
            self._data = data;
    ...
    showType:function(){
        ...
        }else if(this._data.type == 200){   
            this.type.spriteFrame = this.dianshuAtlas.getSpriteFrame("tjd_10dianban");
        ...
        }else if(this._data.type % 10 == 5){
            var card_type = parseInt((this._data.type - 5) / 10);
            this.type.spriteFrame = this.dianshuAtlas.getSpriteFrame("tjd_"+ card_type +"dianban");
        }else {
